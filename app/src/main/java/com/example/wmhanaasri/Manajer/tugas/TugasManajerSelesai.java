...
public class TugasManajerSelesai extends Fragment {
    private SharedPreferences sharedPreferences;
    private RVTugasManajerAdapter2 adapter;

    public TugasManajerSelesai() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_tugas_manajer_selesai, container, false);
        sharedPreferences = requireActivity().getSharedPreferences("tugasmanajerselesai", Context.MODE_PRIVATE);
    ...
    public void fetchData() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, DBConnect.tugasManajerSelesai,
    ...
    private void setupRecyclerView(int dataSize) {
        adapter = new RVTugasManajerAdapter2(requireContext(), dataSize);
        RecyclerView recyclerView = getView().findViewById(R.id.rv_tugasSelesaiDikerjakanManajer);
