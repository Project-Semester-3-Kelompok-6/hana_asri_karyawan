...
public class RekapListTugas extends Fragment {

    private SharedPreferences sharedPreferences;

    private RecyclerView recyclerView;
    private RVTugasRekap adapter;
    public RekapListTugas() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout._manajer_fragment_rekap_list_tugas, container, false);
        sharedPreferences = requireActivity().getSharedPreferences("rekaptugas", Context.MODE_PRIVATE);
    ...
    private void setupRecyclerView(int dataSize) {
        adapter = new RVTugasRekap(requireContext(), dataSize);
        RecyclerView recyclerView = getView().findViewById(R.id.rv_tugasRekapManajer);
