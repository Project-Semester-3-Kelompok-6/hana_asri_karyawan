...
public class KaryawanTetap extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout._manajer_fragment_karyawan_tetap, container, false);
        sharedPreferences = requireActivity().getSharedPreferences("manajerkaryawantetap", Context.MODE_PRIVATE);
    ...
    public void fetchData() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, DBConnect.manajerKaryawanTetap,
    ...
    private void setupRecyclerView(int dataSize) {
        ...
        RecyclerView recyclerView = getView().findViewById(R.id.rv_karyawanManajerTetap);
