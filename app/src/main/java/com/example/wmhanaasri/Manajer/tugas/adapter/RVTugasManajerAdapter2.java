...
public class RVTugasManajerAdapter2 extends RecyclerView.Adapter<RVTugasManajerAdapter2.ViewHolder> {

    private final int dataSize;
    private final SharedPreferences sharedPreferences;

    public RVTugasManajerAdapter2(Context context, int dataSize) {
        this.dataSize = dataSize;
        sharedPreferences = context.getSharedPreferences("tugasmanajerselesai", Context.MODE_PRIVATE);
    }

    @NonNull
    @Override
    public RVTugasManajerAdapter2.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull RVTugasManajerAdapter2.ViewHolder holder, int position) {
